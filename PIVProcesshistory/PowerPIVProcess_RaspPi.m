...
minBubbleSize = 2000; % Minimum size of bubbles
...
rootDir = 'G:/PIV_compare/Bubble_in_chain/12122023_Pylon_RaspPi_Cam/'; % Replace with your directory path
...
for folderIdx = 1:length(folders)
    ...
    [xi, yi] = meshgrid(200:grid_pixel_size:nn-300,200:grid_pixel_size:mm-300);
    ...
    for i = iRange
        k = k + 1;
        AID = fullfile(folderPath, sprintf('image%07d.tif', i));
        BID = fullfile(folderPath, sprintf('image%07d.tif', i + 1));
