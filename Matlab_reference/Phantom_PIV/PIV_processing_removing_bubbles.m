...
threshold = 35000; % particle 
minBubbleSize = 100;
mm = 1600;
nn = 2560;  

dt = 2e-3; % 2 ms in phantom camera
grid_pixel_size = 20;
[xi, yi] = meshgrid(600:grid_pixel_size:2000,200:grid_pixel_size:1000);
[m,n] = size(xi);
ue = zeros(m,n);  
ve = zeros(m,n);
...
for i =iRange
    k = k+1;
    AID = sprintf('../../Phantom_High_Speed_Camera/12012023-Test1/Img%06d.tif',i);
    BID = sprintf('../../Phantom_High_Speed_Camera/12012023-Test1/Img%06d.tif',i+1);
...
save velocity_field_removing_bubble_tes1 vel res xphy yphy dt 
